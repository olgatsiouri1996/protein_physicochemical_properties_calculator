...
def main():
    ...
    ap.add_argument("-pro", "--program", type=int, default=1, widget='Dropdown', choices=[1,2,3], required=False, help="program to select 1) 1 pH value , 2) many pH values 1 per protein, 3) many pH values for all proteins.")
